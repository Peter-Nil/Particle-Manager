...
namespace OpenTissue
{
    namespace gl
    {
        ...
        */
        ...
        {
            //glPushMatrix();             // Added by Christian Larsson
            //glScalef(0.05f, 0.05f, 0.05f); // Added by Christian Larsson
            //glRotatef(-90, 1, 0, 0); // Added by Christian Larsson
            //glRotatef(90, 0, 0, 1); // Added by Christian Larsson
            ...
            glEnd();
            //glPopMatrix();  // Added by Christian Larsson
        }
